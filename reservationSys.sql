...
-- Started on 2021-08-31 17:25:16
...
--
-- TOC entry 3017 (class 0 OID 16706)
-- Dependencies: 201
...
5	14	Elif	Akgün	elifakgun@gmail.com	05559783645
6	11	Aysu	Sözen	aysusozenn@gmail.com	54444444444
7	15	Özlem	Gönül	ozlemgonul@gmail.com	05559874556
8	16	Büsra	Tatlı	busratatli@gmail.com	05335335353
\.


--
-- TOC entry 3023 (class 0 OID 16739)
-- Dependencies: 207
...
5	14	5	2021-08-24	10:00:00	11:00:00	t
3	12	7	2021-08-24	16:00:00	19:00:00	f
7	15	5	2021-08-24	20:00:00	22:00:00	t
8	16	7	2021-09-02	20:30:00	21:30:00	t
\.


--
-- TOC entry 3019 (class 0 OID 16717)
-- Dependencies: 203
...
--
-- TOC entry 3021 (class 0 OID 16731)
-- Dependencies: 205
...
--
-- TOC entry 2882 (class 2606 OID 16766)
-- Name: reservations reservations_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.reservations
    ADD CONSTRAINT reservations_pkey PRIMARY KEY (customer_id);


--
-- TOC entry 2876 (class 2606 OID 16722)
...
--
-- TOC entry 2880 (class 2606 OID 16736)
...
--
-- TOC entry 2878 (class 2606 OID 16728)
...
--
-- TOC entry 2885 (class 2606 OID 16772)
-- Name: reservations fk_table_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.reservations
    ADD CONSTRAINT fk_table_id FOREIGN KEY (table_id) REFERENCES public.tables(table_id) NOT VALID;


--
-- TOC entry 2883 (class 2606 OID 16777)
...
--
-- TOC entry 2884 (class 2606 OID 16767)
-- Name: reservations pk_customer_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.reservations
    ADD CONSTRAINT pk_customer_id FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id) NOT VALID;


-- Completed on 2021-08-31 17:25:16
